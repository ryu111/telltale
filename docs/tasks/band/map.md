...
v0.2 批次（可碰檔案不交集才同批）：B1 {10, 11, 19} → B2 {12, 14} → B3 {13, 15} → B4 {16} → B5 {17} → B6 {18, 20} → B7 {21} → B8 {22} → B9 {23}。2026-09-18 全部 merged（21 於真機實測後補開，同日 merged）。v0.2b（2026-09-18 真機回饋）：B10 {24, 25} → B11 {26} → B12 {27} → 28（主 agent 真機）。2026-09-18 全部 merged，28 的證據在 `docs/實測/v02b.md`。
...
v0.2c（2026-09-18 真機回饋）：30 → 31 → 32，全部 merged；33 為主 agent 真機實測（待開）。
